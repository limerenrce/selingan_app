    ...
    return (
      <>
        ...
        >
          ...
          <Row gutter={16} style={{ padding: "0 20px", marginTop: "72px" }}>
            <Col className="mb-24">
              <Card
                bordered={false}
                ...
                <Flex vertical>
                  ...
                  >
                    ...
                    <Paragraph className="text-justify">
                      In this Chocholate making class, you will explore the art
                      of poetry from different perspectives, discovering
                      techniques to enhance your expression, rhythm, and
                      storytelling. We will delve into both classic and modern
                      poetry styles, learning how to convey emotions and connect
                      with audiences. You will have the chance to work on your
                      own verses, receive feedback, and understand the impact of
                      imagery, metaphors, and poetic devices. This course is an
                      inspiring journey to help you refine your voice, connect
                      with other poetry lovers, and create powerful, memorable
                      pieces.
                    </Paragraph>
                  </div>
            ...
            <div style={{ width: "100%" }}>
              <div className="flex items-center justify-center mb-8">
                <Text className="text-3xl font-bold">
                  Choose the Event That Sparks Your Passion{" "}
                </Text>
              </div>
              <div
                        ...
                        <Row>
                          ...
                          <Col span={19}>
                            ...
                            <p className="text-gray-400 text-lg flex items-center">
                              ...
                              <span className="ml-2">By {item.created_by}</span>
                            </p>
